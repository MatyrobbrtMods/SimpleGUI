...
// Copied from https://github.com/mekanism/Mekanism/blob/725c37646d3302060c805dccc0c92f1ec590b75d/src/main/java/mekanism/common/lib/Color.java
public class Color {

    public static final Color WHITE = rgbad(1F, 1F, 1F, 1F);
    public static final Color BLACK = rgbad(0F, 0F, 0F, 1F);
    public static final Color RED   = rgbad(1F, 0, 0, 1F);
    ...
    public Color lighter(double amount) {
